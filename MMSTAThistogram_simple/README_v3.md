...
## ![qlogo](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png) **MMSTAThistogram_simple**
...
Example : - 'Shows a histogram of the variable TOTALAREA of the USCRIME data set. The number of
bins is set to 30.'
```
